...
{
    public partial class Главное_меню_администратора : Form
    {
        ...
        public Главное_меню_администратора()
        {
            InitializeComponent();
        ...
        private void Главное_меню_администратора_Load(object sender, EventArgs e)
        {
        ...
        {
            Hide();
            Регистрация_пользователей newForm = new Регистрация_пользователей();
            newForm.ShowDialog();
            Show();
            this.Close();
        }
